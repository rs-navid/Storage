...
const RequestReport = (props) => {
  ...
  const loadData = async (query) => {
    const results = await props.getRequests(query, "report", { startDate: filter.startDate, endDate: filter.endDate });
...
export default withRouter(connect(null, { showDialog, getRequests })(RequestReport));
