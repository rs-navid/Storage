      ...
      <Menu title="جستجو">
        <div className="search-wrapper">
          <div className="field-wrapper field-100 wrap">
            ...
            <Input placeholder="نام دسته بندی" type="text" name="name" value={props.filter.name} onChange={handleSearchInputs} />
          </div>
          <div className="field-wrapper field-100 wrap">
            <label>نام کالا:</label>
            <Input placeholder="نام کالا" type="text" name="subName" value={props.filter.subName} onChange={handleSearchInputs} />
          </div>
