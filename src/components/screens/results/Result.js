...
import { getRequestsByType } from "../../../store/actions/requestActions";
...
const Request = (props) => {
  ...
  useEffect(() => {
    ...
    setFilter(query);
    setExamType(query.type);

    loadData(qs.stringify(query), query.type);
  ...
  const handlePageChange = (event, value) => {
    ...
    loadData(qs.stringify(query), examType);
  };
...
export default withRouter(connect(null, { showDialog, getRequestsByType })(Request));
